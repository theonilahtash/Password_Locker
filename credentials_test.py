...
class TestCredential(unittest.TestCase):
   ...
   def setUp(self):
      ...
      '''
      self.new_credential = Credential("theonilahtash","0733445566","theonilahtash@gmail.com","tash1234") # create credential object
   ...
   def test_init(self):
      ...
      self.assertEqual(self.new_credetial.phone_number,"0733445566") 
